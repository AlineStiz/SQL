...
nome_func as nome,
cpf_func as CPF,
cod_dep_fk as codigo_do_depatamento,
cod_end_fk as codigo_do_endereço
from
funcionario, departamento, endereco 
where 
...
cliente, endereco 
where 
(cliente.cod_end_fk = endereco.cod_end);

select * from venda;

select 
data_vend as Data_da_venda,
valortotal_vend as Valor,
desconto_vend as desconto,
formpag_vend as forma_de_pagamento,
cod_func_fk as Codigo_do_funcionario,
cod_cli_fk as Codigo_do_Cliente 
from
venda, funcionario, cliente 
where 
(venda.cod_func_fk = funcionario.cod_func) and
(venda.cod_cli_fk = cliente.cod_cli);

select * from compra;

select 
data_comp as Data_da_compra,
valortotal_comp as Valor,
formpag_comp as forma_de_pagamento,
cod_func_fk as Codigo_do_funcionario,
cod_forn_fk as Codigo_do_fornecedor 
from
compra, funcionario, fornecedor 
where 
(compra.cod_func_fk = funcionario.cod_func) and
(compra.cod_forn_fk = fornecedor.cod_forn);
...
select 
data_comp as 'Data da compra',
valortotal_comp as Valor,
formpag_comp as 'forma de pagamento',
cod_func_fk as 'Codigo do funcionario',
cod_forn_fk as 'Codigo do fornecedor' 
from
compra
...
(venda.data_vend between '2018-01-01' and ''2020-12-31) ;
